...
10X protocol for ATACseq nuclei isolation can be found at [10x Nuclei Isolation Protocol](./demo_figure/CG000169_DemonstratedProtocol_NucleiIsolation_ATAC_Sequencing_Rev_E.pdf). By the time this README is written, we (me & Severin) have tried once this protocol, and the image of isolated nuclei is found in the local folder with name: [contess_image_nuclei_isolation](./contess_image_nuclei_isolation/). We did not make modifications to the protocol. For questions regarding the protocol, you can contact Andreia Gouvea ([andreia.gouvea@10xgenomics.com](andreia.gouvea@10xgenomics.com)), a field application scientist from 10x genomics. I have mainly been communicating with her regarding details of the protocol. You should also contact her for future purchase of the actual kit.

## 📌 5. Future plan
Future plan is to use this workflow to analyse our in house EpiATAC dataset. The current protocol being tested is the 10x EpiATAC, but bulk ATAC-seq will mainly be performed, according to the antrag. For the latest plan of the antrag, see Trained Immunity Antrag. 