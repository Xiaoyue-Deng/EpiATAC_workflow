...
## 📌 5. Future plan
Future plan is to use this workflow to analyse our in house EpiATAC dataset. The current choice of method is 10x EpiATAC, and we will do both bulk and atac-sequencing. For the latest plan of the antrag, see [Trained Immunity Antrag](./demo_figure/Budget_Trained_Immunity_Antrag_v1.docx). 